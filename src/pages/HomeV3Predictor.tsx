// src/pages/Home.tsx  (Variant 3 – AI-predictor-first landing)
...
const Home: React.FC = () => {
  ...
  const chips = [
    { label: "Reads PYQs like a topper", emoji: "📊" },
    { label: "Builds 80-mark predictions", emoji: "🤖" },
    { label: "Then plans your days", emoji: "📅" },
  ];

  const howItWorks = [
    {
      step: 1,
      title: "We scan past papers",
      body: "CBSE PYQs, sample papers and blueprints go into the AI brain.",
    },
    {
      step: 2,
      title: "We find the hidden pattern",
      body: "Topics tagged as must-crack, high-ROI and good-to-do.",
    },
    {
      step: 3,
      title: "You get predicted 80-mark sets",
      body: "Topic-wise HPQs and full predictive papers.",
    },
    {
      step: 4,
      title: "Mentor turns it into your plan",
      body: "Daily tasks and mocks matched to your target %.",
    },
  ];
      ...
      <div className="mx-auto max-w-[1120px] px-4 pt-3 pb-10">
        ...
        <section className="mb-10 grid items-center gap-7 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
          ...
          <div>
            ...
            <h1 className="mb-2 text-[2.4rem] font-extrabold leading-[1.1] text-slate-950 md:text-[2.6rem]">
              Your board paper{" "}
              <span className="text-blue-600">has a pattern.</span>
            </h1>

            <p className="mb-4 max-w-xl text-[0.96rem] leading-7 text-slate-600">
              LazyTopper&apos;s AI reads years of CBSE papers to{" "}
              <strong>predict where marks will come from</strong> and then
              builds a simple plan so you know exactly{" "}
              <strong>what to focus on today.</strong>
            </p>
            ...
            <div className="mb-3 mt-1 max-w-md rounded-2xl bg-white p-3.5 shadow-[0_14px_32px_rgba(15,23,42,0.12)]">
              <p className="mb-2 text-[0.8rem] text-slate-600">
                Get your AI-predicted board plan in{" "}
              ...
              <button className="w-full cursor-pointer rounded-full bg-gradient-to-tr from-violet-500 via-blue-500 to-emerald-500 px-4 py-2.5 text-[0.9rem] font-semibold text-slate-50 shadow-[0_14px_30px_rgba(59,130,246,0.5)] hover:brightness-105">
                Get my predicted plan
              </button>
              <p className="mt-1.5 text-[0.7rem] text-slate-400">
                No spam. Just your plan link and exam-time reminders.
              </p>
            </div>
            ...
            <div className="mt-2 text-[0.8rem] text-slate-600">
              ...
              <span className="opacity-90">
                Let&apos;s follow the pattern, not panic. 👀
              </span>
            </div>
            ...
            <div className="mt-3 text-[0.8rem] text-slate-500">
              ...
              >
                peek at Class 10 Maths trends →
              </button>
            </div>
          </div>

          {/* Right: AI predictor card */}
          <div className="min-h-[260px] rounded-[32px] bg-gradient-to-br from-slate-950 via-slate-900 via-20% to-violet-500 p-5 text-slate-50 shadow-[0_26px_70px_rgba(15,23,42,0.7)]">
            ...
            <p className="mb-2 text-[0.9rem] font-semibold">
              Think of it like a topper&apos;s brain that has read all the PYQs.
            </p>
            <ul className="list-none space-y-1.5 text-[0.8rem] leading-6 text-slate-100/95">
              <li>📊 Spots which topics keep coming again and again</li>
              <li>🎯 Tags chapters as must-crack, high-ROI, good-to-do</li>
              <li>📄 Assembles 80-mark predictive papers, CBSE style</li>
              <li>📅 Feeds all of this into your daily plan</li>
            </ul>
            <p className="mt-3 text-[0.78rem] text-slate-100/85">
              Less guesswork, more pattern-based preparation.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <p className="mb-4 text-[0.86rem] text-slate-500">
            From raw PYQs to a day-wise plan.
          </p>
        ...
        <section id="features" className="mb-9">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-3xl border border-slate-300/70 bg-slate-50 p-3.5 shadow-[0_14px_30px_rgba(148,163,184,0.28)]">
              ...
              <p className="mb-2 text-[0.8rem] text-slate-600">
                10-year CBSE analysis showing which chapters keep repeating in
                papers.
              </p>
              <button
                onClick={goToTrends}
            ...
            <div className="rounded-3xl border border-slate-300/70 bg-slate-50 p-3.5 shadow-[0_14px_30px_rgba(148,163,184,0.28)]">
              ...
              <p className="mb-2 text-[0.8rem] text-slate-600">
                80-mark, CBSE-style papers built from your AI prediction engine
                and topic tags.
              </p>
              <button
            ...
            <div className="rounded-3xl border border-slate-300/70 bg-slate-50 p-3.5 shadow-[0_14px_30px_rgba(148,163,184,0.28)]">
              ...
              <p className="mb-2 text-[0.8rem] text-slate-600">
                Remix your own mini-mocks by topic, tier and difficulty in a few
                clicks.
              </p>
              <button
            ...
            <div className="rounded-3xl border border-slate-300/70 bg-slate-50 p-3.5 shadow-[0_14px_30px_rgba(148,163,184,0.28)]">
              ...
              <p className="mb-2 text-[0.8rem] text-slate-600">
                Takes the predictions and converts them into a{" "}
                <strong>marks-first</strong> study roadmap for you.
              </p>
              <button
                onClick={goToMentor}
                className="cursor-pointer rounded-full border border-blue-500/60 bg-blue-50/90 px-2.5 py-1 text-[0.78rem] text-blue-700 hover:bg-blue-100"
          ...
          <div className="grid items-stretch gap-4 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
            <div>
              ...
              <p className="mb-2 text-[0.85rem] text-slate-600">
                After the predictions are ready, the mentor shifts into planner
                mode and turns them into daily tasks.
              </p>
              <ul className="mb-2 list-disc pl-5 text-[0.8rem] leading-7 text-slate-700">
                <li>
                  Prioritises must-crack topics first, then high-ROI chapters.
                </li>
                <li>
                  Connects to <strong>TopicHub</strong>,{" "}
                  <strong>HPQ bank</strong> and{" "}
                  <strong>Mock Builder</strong> for smooth “see → practise →
                  test”.
                </li>
                <li>
                  Later: uses your mock scores to sharpen predictions further.
                </li>
              </ul>
              <button
                onClick={goToMentor}
            ...
            <div className="rounded-2xl bg-gradient-to-br from-slate-950 via-slate-900 to-blue-700 p-3.5 text-[0.78rem] text-slate-100 shadow-[0_16px_40px_rgba(15,23,42,0.7)]">
              ...
              <div className="mb-2 rounded-xl bg-slate-950/80 p-2.5">
                <p className="mb-1 text-slate-100">
                  <strong>Prediction snapshot</strong> for 80% target:
                </p>
                <ul className="ml-4 list-disc space-y-0.5 text-[0.78rem] text-slate-100/90">
                  <li>93 days left • 1 hr/day</li>
                  <li>~60% marks from 🔥 must-crack chapters</li>
                  <li>~30% from 💎 high-ROI + revision</li>
                  <li>~10% from 🌈 good-to-do / buffer</li>
                </ul>
              </div>
              <p className="text-slate-100/90">
                “Today’s focus: <strong>Trigonometry</strong> +{" "}
