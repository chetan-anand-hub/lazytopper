...
export const topicHubV2Enrichment: Record<string, Partial<TopicHubV2Content>> = {
  ...
  "triangles": {
    workedExamples: [
      {
        title: "Applying BPT",
        question: "In ΔABC, D and E are points on AB and AC respectively such that DE ∥ BC. If AD = 2 cm, DB = 4 cm and AC = 9 cm, find AE using the basic proportionality theorem."
      },
      {
        title: "Using Pythagoras’ theorem",
        question: "Check whether a triangle with sides 7 cm, 24 cm and 25 cm is right‑angled and state the right angle."
      }
    ],
    competencies: [
